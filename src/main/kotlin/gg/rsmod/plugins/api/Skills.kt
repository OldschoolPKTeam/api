...
object Skills {
    ...
    /**
     * @return [ATTACK], [STRENGTH], [DEFENCE], [RANGED] [MAGIC], [PRAYER], [HITPOINTS]
     */
    fun getCombatSkills(): Set<Int> = setOf(ATTACK, STRENGTH, DEFENCE, RANGED, MAGIC, PRAYER, HITPOINTS)

    fun getNonCombatSkills(): Set<Int> = allSkills().filter { all -> getCombatSkills().any { cmb -> all == cmb } }.toSet()
