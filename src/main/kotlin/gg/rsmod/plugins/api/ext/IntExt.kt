...
/**
 * Generates an interface hash from the parent and child interface ids.
 */
infix fun Int.interfaceHash(component: Int): Int = (this shl 16) or component

/**
 * Converts an interface hash back to parent and child interface ids.
 */
fun Int.hashToInterface(): Pair<Int, Int> = Pair(this shr 16, this and 0xFFFF)
